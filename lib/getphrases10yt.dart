...
class GetPhrases10yt extends StatefulWidget {
  ...
  this.p6, this.p7,this.p8,this.p9,this.p10,this.p11,this.p12,this.p13) ;
  
  
  
  @override
  _GetPhrases10ytState createState() => 
...
//share에서 사용한다 
  ...
  Widget build(BuildContext context) {
    ...
    //listPage() {
        ...
        print ('test provider' + '${langSet.langSet}');
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: GestureDetector(
                   onTap: () =>
                            phraseSpeech('en-US', documentSnapshot.data['${langSet.langSet}']),
                            //phraseSpeech('en-US', documentSnapshot.data['eng']),
                  child: SubstringHighlight(
                    text: documentSnapshot.data['${langSet.langSet}'],
                    //text: documentSnapshot.data['eng'],
                    term: documentSnapshot.data[p3],
                ...
                children: <Widget>[
                  ...
                  Wrap(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () =>
                            phraseSpeech(p4, documentSnapshot.data[p5]),
                            //phraseSpeech("ko-KR", documentSnapshot.data['kor']),
                            //phraseSpeech("ko-KR", documentSnapshot.data['kor']),
                        child: SubstringHighlight(
                          text: documentSnapshot.data[p5],
                          term: documentSnapshot.data[p6],
                          textStyle: TextStyle(
                            fontFamily: "NotoSansCJKkr",
                            fontSize: 12,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () =>
                          phraseSpeech(p4, documentSnapshot.data[p5]),
                      child: SubstringHighlight(
                        text: documentSnapshot.data[p7],
                        term: documentSnapshot.data[p8],
                        textStyle: TextStyle(
                          fontFamily: "NotoSansCJKkr",
                          fontSize: 12,
                  ...
                  Wrap(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () =>
                            phraseSpeech(p9, documentSnapshot.data[p10]),
                        child: SubstringHighlight(
                          text: documentSnapshot.data[p10],
                          term: documentSnapshot.data[p11],
                          textStyle: TextStyle(
                            fontFamily: "NotoSansCJKkr",
                            fontSize: 12,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () =>
                          phraseSpeech(p9, documentSnapshot.data[p10]),
                      child: SubstringHighlight(
                        text: documentSnapshot.data[p12],
                        term: documentSnapshot.data[p13],
                        textStyle: TextStyle(
                          fontFamily: "NotoSansCJKkr",
                          fontSize: 12,
