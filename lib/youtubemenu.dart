    ...
    return AppBuilder(
      builder: (context) {
        return MaterialApp(
          ...
          home: YoutubePage(firestoreName: 'Youtube english'),
        );
      },
    );
  }
...
class YoutubePage extends StatefulWidget {
  YoutubePage({Key key, this.firestoreName}) : super(key: key);
...
class _YoutubePageState extends State<YoutubePage> {
  YoutubePlayerController _controller = YoutubePlayerController(
      initialVideoId: Get.arguments, // id youtube video
      //initialVideoId: 'C2VN2swmngI', // id youtube video
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            ...
                            child: Line2Text(documentSnapshot.data[_line1prn],
                                documentSnapshot.data[_line1hprn], 15),
                          ),
                        ),
                      ],
                    ),
